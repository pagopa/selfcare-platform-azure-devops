...
# DEV
#
module "DEV-SELC-PNPG-TLS-CERT-SERVICE-CONN" {
...
resource "azurerm_key_vault_access_policy" "DEV-SELC-PNPG-TLS-CERT-SERVICE-CONN_kv_access_policy" {
  provider     = azurerm.dev
  key_vault_id = data.azurerm_key_vault.domain_kv_dev.id
  tenant_id    = module.secrets_core_prod.values["PAGOPAIT-TENANTID"].value
  object_id    = module.DEV-SELC-PNPG-TLS-CERT-SERVICE-CONN.service_principal_object_id
