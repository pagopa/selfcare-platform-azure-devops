locals {
  ...
  selc-fe-common-variables_deploy-pnpg = {
    ...
    dev_react_app_url_cdn                      = "https://imprese.dev.notifichedigitali.it"
    dev_react_app_url_storage                  = "https://selcdweupnpgcheckoutsa.z6.web.core.windows.net"
    dev_react_app_products_asset               = "https://imprese.dev.notifichedigitali.it/assets/products.json"
    dev_react_app_url_fe_login                 = "https://imprese.dev.notifichedigitali.it/auth"
    dev_react_app_url_fe_onboarding            = "https://imprese.dev.notifichedigitali.it/onboarding"
    dev_react_app_url_fe_onboarding-pnpg       = "https://imprese.dev.notifichedigitali.it/onboarding-pnpg"
    dev_react_app_url_fe_dashboard             = "https://imprese.dev.notifichedigitali.it/dashboard"
    dev_react_app_url_fe_dashboard_admin       = "https://imprese.dev.notifichedigitali.it/microcomponents/dashboard/admin"
    dev_react_app_url_fe_dashboard_users       = "https://imprese.dev.notifichedigitali.it/microcomponents/dashboard/users"
    dev_react_app_url_fe_dashboard_groups      = "https://imprese.dev.notifichedigitali.it/microcomponents/dashboard/groups"
    dev_react_app_url_fe_assistance            = "https://imprese.dev.notifichedigitali.it/assistenza"
    dev_react_app_url_fe_landing               = "https://imprese.dev.notifichedigitali.it/auth/logout" // TODO when the landing will exists, replace this with the correct URL
    dev_react_app_url_fe_token_exchange        = "https://imprese.dev.notifichedigitali.it/token-exchange"
