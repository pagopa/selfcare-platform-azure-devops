locals {
  ...
  selc-fe-common-variables_deploy-pnpg = {
    ...
    uat_react_app_login_alert_banner           = "https://dev.selfcare.pagopa.it/assets/login-alert-message.json"
    ...
    prod_react_app_login_alert_banner           = "https://dev.selfcare.pagopa.it/assets/login-alert-message.json"
