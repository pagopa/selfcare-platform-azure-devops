locals {
  ...
  selc-fe-common-variables_deploy-pnpg = {
    ...
    dev_react_app_url_privacy_disclaimer       = "https://imprese.notifichedigitali.it/informativa-privacy"
    dev_react_app_url_terms_and_conditions     = "https://imprese.notifichedigitali.it/termini-di-servizio"
    ...
    uat_react_app_url_privacy_disclaimer       = "https://imprese.notifichedigitali.it/informativa-privacy"
    uat_react_app_url_terms_and_conditions     = "https://imprese.notifichedigitali.it/termini-di-servizio"
