variable "selfcare-ms-user-group" {
  default = {
    repository = {
      organization    = "pagopa"
    ...
    pipeline = {
      ...
      enable_deploy      = true
      path               = "pnpg\\selfcare-ms-user-group"
    }
  }
}
...
locals {
  # global vars
  selfcare-ms-user-group-variables = {
  ...
  # global secrets
  selfcare-ms-user-group-variables_secret = {

  }
  # code_review vars
  selfcare-ms-user-group-variables_code_review = {
    sonarcloud_service_conn = "SONARCLOUD-SERVICE-CONN"
    sonarcloud_org          = var.selfcare-ms-user-group.repository.organization
    sonarcloud_project_key  = "${var.selfcare-ms-user-group.repository.organization}_${var.selfcare-ms-user-group.repository.name}"
    sonarcloud_project_name = var.selfcare-ms-user-group.repository.name
  }
  # code_review secrets
  selfcare-ms-user-group-variables_secret_code_review = {

  }
  # deploy vars
  selfcare-ms-user-group-variables_deploy = {

    K8S_IMAGE_REPOSITORY_NAME        = replace(var.selfcare-ms-user-group.repository.name, "-", "")
    DEPLOY_NAMESPACE                 = local.domain
    DEPLOYMENT_NAME                  = "ms-user-group"
    SETTINGS_XML_RW_SECURE_FILE_NAME = "settings-rw.xml"
    SETTINGS_XML_RO_SECURE_FILE_NAME = "settings-ro.xml"
    HELM_RELEASE_NAME                = var.selfcare-ms-user-group.repository.name
  ...
  # deploy secrets
  selfcare-ms-user-group-variables_secret_deploy = {

  }
}

module "selfcare-ms-user-group_code_review" {
  source = "git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review?ref=v2.6.5"
  count  = var.selfcare-ms-user-group.pipeline.enable_code_review == true ? 1 : 0
  ...
  variables = merge(
    local.selfcare-ms-user-group-variables,
    local.selfcare-ms-user-group-variables_code_review,
  )

  variables_secret = merge(
    local.selfcare-ms-user-group-variables_secret,
    local.selfcare-ms-user-group-variables_secret_code_review,
  )
...
module "selfcare-ms-user-group_deploy" {
  ...
  variables = merge(
    local.selfcare-ms-user-group-variables,
    local.selfcare-ms-user-group-variables_deploy,
  )

  variables_secret = merge(
    local.selfcare-ms-user-group-variables_secret,
    local.selfcare-ms-user-group-variables_secret_deploy,
  )
