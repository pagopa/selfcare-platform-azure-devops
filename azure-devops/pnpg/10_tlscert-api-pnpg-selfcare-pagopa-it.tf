...
module "tlscert-api-pnpg-selfcare-pagopa-it-cert_az" {
  ...
  path                         = "${local.domain}\\${var.tlscert-api-pnpg-selfcare-pagopa-it.pipeline.path}"
  ...
  dns_zone_resource_group = local.tlscert-api-pnpg-selfcare-pagopa-it.dns_zone_resource_group
  ...
  credential_subcription              = local.tlscert-api-pnpg-selfcare-pagopa-it.credential_subcription
  credential_key_vault_name           = local.tlscert-api-pnpg-selfcare-pagopa-it.credential_key_vault_name
  credential_key_vault_resource_group = local.tlscert-api-pnpg-selfcare-pagopa-it.credential_key_vault_resource_group
  ...
  service_connection_ids_authorization = local.tlscert-api-pnpg-selfcare-pagopa-it.service_connection_ids_authorization
  ...
  schedules = {
    ...
    branch_filter = {
      include = [var.tlscert-api-pnpg-selfcare-pagopa-it.repository.branch_name]
      exclude = []
    }
  }
