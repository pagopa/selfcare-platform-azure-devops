...
resource "azuredevops_serviceendpoint_azurecr" "selfcare-docker-common-dev" {
  ...
  azurecr_spn_tenantid      = module.secrets_core_prod.values["PAGOPAIT-TENANTID"].value
  azurecr_subscription_id   = module.secrets_core_prod.values["PAGOPAIT-DEV-SELFCARE-SUBSCRIPTION-ID"].value
}
...
resource "azuredevops_serviceendpoint_azurecr" "selfcare-docker-common-uat" {
  ...
  azurecr_spn_tenantid      = module.secrets_core_prod.values["PAGOPAIT-TENANTID"].value
  azurecr_subscription_id   = module.secrets_core_prod.values["PAGOPAIT-UAT-SELFCARE-SUBSCRIPTION-ID"].value
}
...
resource "azuredevops_serviceendpoint_azurecr" "selfcare-docker-common-prod" {
  ...
  azurecr_spn_tenantid      = module.secrets_core_prod.values["PAGOPAIT-TENANTID"].value
  azurecr_subscription_id   = module.secrets_core_prod.values["PAGOPAIT-PROD-SELFCARE-SUBSCRIPTION-ID"].value
}
