...
locals {
  tlscert-uat01-idpay-internal-uat-cstar-pagopa-it = {
    ...
    service_connection_ids_authorization = [
      module.UAT-CSTAR-IDPAY-TLS-CERT-SERVICE-CONN.service_endpoint_id,
    ]
  }
  tlscert-uat01-idpay-internal-uat-cstar-pagopa-it-variables = {
    KEY_VAULT_SERVICE_CONNECTION = module.UAT-CSTAR-IDPAY-TLS-CERT-SERVICE-CONN.service_endpoint_name,
...
module "tlscert-uat01-idpay-internal-uat-cstar-pagopa-it-cert_az" {
  ...
  name       = "${var.tlscert-uat01-idpay-internal-uat-cstar-pagopa-it.pipeline.dns_record_name}.${var.tlscert-uat01-idpay-internal-uat-cstar-pagopa-it.pipeline.dns_zone_name}"
  #tfsec:ignore:general-secrets-no-plaintext-exposure
  #tfsec:ignore:GEN003
  ...
  credential_subcription              = local.tlscert-uat01-idpay-internal-uat-cstar-pagopa-it.credential_subcription
