locals {
  ...
  idpay-fe-common-variables_deploy = {
    ...
    dev_react_app_url_fe_assistance          = "/portale-enti/assistenza"
    ...
    uat_react_app_url_fe_assistance          = "/portale-enti/assistenza"
    ...
    prod_react_app_url_fe_assistance          = "/portale-enti/assistenza"
