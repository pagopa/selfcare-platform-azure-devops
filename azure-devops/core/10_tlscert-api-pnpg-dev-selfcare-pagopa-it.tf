...
locals {
  ...
  tlscert-api-pnpg-dev-selfcare-pagopa-it-variables = {
    KEY_VAULT_CERT_NAME          = "${replace(var.tlscert-api-pnpg-dev-selfcare-pagopa-it.pipeline.dns_record_name, ".", "-")}-${replace(var.tlscert-api-pnpg-dev-selfcare-pagopa-it.pipeline.dns_zone_name, ".", "-")}"
...
module "tlscert-api-pnpg-dev-selfcare-pagopa-it-cert_az" {
  ...
  path                         = "${local.selfcare_legacy.pipelines_folder_name}\\${var.tlscert-api-pnpg-dev-selfcare-pagopa-it.pipeline.path}"
  ...
  dns_zone_resource_group = var.tlscert-api-pnpg-dev-selfcare-pagopa-it.pipeline.dns_zone_resource_group
