locals {
  ...
  selc-fe-common-variables_deploy = {
    ...
    dev_react_app_url_api_login                = "https://api.dev.selfcare.pagopa.it/login/v1"
    dev_react_app_url_api_login_spid           = "https://api.dev.selfcare.pagopa.it/spid-login/v1"
    ...
    uat_react_app_url_api_login_spid           = "https://api.uat.selfcare.pagopa.it/spid-login/v1"
