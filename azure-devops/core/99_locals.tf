locals {
  ...
  selc-fe-common-variables_deploy = {
    ...
    dev_react_app_url_privacy_disclaimer       = "https://selfcare.pagopa.it/auth/informativa-privacy"
    dev_react_app_url_terms_and_conditions     = "https://selfcare.pagopa.it/auth/termini-di-servizio"
    ...
    uat_react_app_url_privacy_disclaimer       = "https://selfcare.pagopa.it/auth/informativa-privacy"
    uat_react_app_url_terms_and_conditions     = "https://selfcare.pagopa.it/auth/termini-di-servizio"
