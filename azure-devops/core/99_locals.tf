locals {
  ...
  selc-fe-common-variables_deploy = {
    ...
    dev_react_app_aggregates_example_csv       = "https://dev.selfcare.pagopa.it/resources/template.csv"
    ...
    uat_react_app_aggregates_example_csv       = "https://uat.selfcare.pagopa.it/resources/template.csv"
    ...
    prod_react_app_aggregates_example_csv       = "https://selfcare.pagopa.it/resources/template.csv"
